...
export default function Experience() {
  return (
    // Додав bg-gray-50 (або bg-cloud, якщо він у тебе налаштований) для легкого акцентного фону
    <section id="experience" className="py-24 bg-gray-50 border-y border-line">
      <div className="max-w-content mx-auto px-6 lg:px-10">
        ...
        <div className="space-y-16">
          {experience.map((job) => (
            <div key={job.id} className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
              ...
              <div className="md:col-span-8 lg:col-span-9">
                ...
                <div className="space-y-6 text-body text-graphite leading-relaxed">
                  {job.achievements.ua.map((item: any, index: number) => {
                    // Шукаємо двокрапку, щоб зробити заголовок пункту жирним (наприклад, "Управління командою:")
